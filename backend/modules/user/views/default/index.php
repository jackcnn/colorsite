...
<div class="wrapper">
    ...
    <div class="el-row container">
        <div class="menu el-col el-col-4">
            <ul class="el-menu">
                <li class="el-menu-item" style="padding-left: 20px;">页面1</li>
                <li class="el-menu-item" style="padding-left: 20px;">页面2</li>
                <li class="el-menu-item is-active" style="padding-left: 20px;">页面3</li>
            </ul>
        </div>
                ...
                <div class="el-table__header-wrapper">
                    <table cellspacing="0" cellpadding="0" border="0" class="el-table__header" style="width: 840px;">
                        <colgroup>
                            ...
                            <col name="el-table_1_column_5" width="160">
            ...
            <div class="pagination el-pagination">
                ...
                <span class="el-pagination__sizes">
                    <div class="el-select">
                            ...
                            <div class="el-scrollbar">
                                <div class="el-select-dropdown__wrap el-scrollbar__wrap el-scrollbar__wrap--hidden-default">
                                    <ul class="el-scrollbar__view el-select-dropdown__list" style="position: relative;">
                                        <li class="el-select-dropdown__item selected"><span>10 条/页</span></li>
                                        <li class="el-select-dropdown__item"><span>20 条/页</span></li>
                                        <li class="el-select-dropdown__item"><span>30 条/页</span></li>
                                        <li class="el-select-dropdown__item"><span>40 条/页</span></li>
                                        <li class="el-select-dropdown__item"><span>50 条/页</span></li>
                                        <li class="el-select-dropdown__item"><span>100 条/页</span></li>
                                        <div class="resize-triggers">
                                            <div class="expand-trigger">
                        ...
                        <div class="resize-triggers">
                            <div class="expand-trigger">
                                <div style="width: 111px; height: 29px;"></div>
                            </div>
                            <div class="contract-trigger"></div>
                        </div>
                    </div>
    ...
    <div class="el-dialog__wrapper" style="display: none;">
        <div class="el-dialog el-dialog--tiny" style="margin-bottom: 50px; top: 15%;">
            <div class="el-dialog__header"><span class="el-dialog__title">切换主题色</span>
                <div class="el-dialog__headerbtn"><i class="el-dialog__close el-icon el-icon-close"></i></div>
            </div>
        </div>
    </div>
    <div class="el-dialog__wrapper" style="display: none;">
        <div class="el-dialog el-dialog--small" style="margin-bottom: 50px; top: 15%;">
            <div class="el-dialog__header"><span class="el-dialog__title">帮助</span>
                <div class="el-dialog__headerbtn"><i class="el-dialog__close el-icon el-icon-close"></i></div>
            </div>
            <div class="el-dialog__footer">
                <span class="dialog-footer"><button type="button" class="el-button el-button--primary"><span>确定</span></button></span>
            </div>
        </div>
    </div>
</div>
