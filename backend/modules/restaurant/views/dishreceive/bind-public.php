...
?>
    ...
    <div class="msg">
        ...
        <span style="color: #ff5500;font-weight: bolder;">注意：必须关注公众号"橙蓝科技服务平台"才能收到通知消息！</span>
    </div>
...
$str = \yii\helpers\Url::to(['/dish/template/index.html','store_id'=>$store_id,'id'=>$id,'token'=>$token],'https');
