...
class SendHelper
{
    const wx_custom_send = 'https://api.weixin.qq.com/cgi-bin/message/custom/send?access_token=';
    ...
    public static function text($tousername, $content,$accessToken){
        ...
        return CurlHelper::callWebServer(self::wx_custom_send.$accessToken, $template, self::action_type);
    }
